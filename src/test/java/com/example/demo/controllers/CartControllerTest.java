...
public class CartControllerTest {
    ...
    private BigDecimal testPrice = new BigDecimal(1000.10);
    ...
    public void addToCartSuccess() {
        ...
        assertEquals(testItem.getPrice().multiply(new BigDecimal(quantity + 1)), Objects.requireNonNull(response.getBody()).getTotal());
    }
