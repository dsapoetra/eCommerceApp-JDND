...
public class ItemControllerTest {
    ...
    public void getItemById() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals(testItem.getId(), Objects.requireNonNull(response.getBody()).getId());
    ...
    public void getItemsByName() {
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals(testItem.getId(), Objects.requireNonNull(response.getBody()).get(0).getId());
